...
function App() {
 ...
 <div className="code h-[50vh] flex">
    ...
    <textarea className="w-full h-60 outline-0 selection:bg-black h-[calc(100%-72px)]	bg-[#d15e00] p-2 text-white text-xl" style={{resize: "none"}} spellcheck="false" onChange={(e) => setHtml(e.currentTarget.value)} name="html" id="html"></textarea>
    </div>
  ...
  <textarea className="w-full h-60 outline-0 selection:bg-black h-[calc(100%-72px)]	bg-[#005eff] p-2 text-white text-xl" style={{resize: "none"}} spellcheck="false" onChange={(e) => setCss(e.currentTarget.value)} name="css" id="css" ></textarea>
    </div>
  ...
  <textarea className="w-full h-60 outline-0 selection:bg-black h-[calc(100%-72px)] bg-[#c2bb00] p-2 text-white text-xl" style={{resize: "none"}} spellcheck="false" onChange={(e) => setJs(e.currentTarget.value)} name="javascript" id="javascript" ></textarea>
    </div>
    </div>
